	...
	<div class="modal-dialog" role="document">
		<div class="modal-content">
			...
			<div class="modal-body">
				<div class="row">
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="hidden" name="id" id="id" /><br /> <input type="hidden" name="studentid" id="studentid"
						value="${user.stuinfo.studentid}" />
													...
													<tr>
														<td width="28%" height="30" style="padding-left: 20px;">功能导航：
															<button style="background: #7bbfea">
																<a href="ClassidAdd.jsp">添加班级</a>
															</button>
														</td>
														<td width="72%">查询： <select name="text3" id="searchType">
																<option value="">全部</option>
																<option value="班级编号">班级编号</option>
																<option value="班级名称">班级名称</option>
														</select> <input name="text4" type="text" id="text4"> <input type="submit" name="button" id="button" value="点击查询"></td>
													</tr>
												</table>
											</form>
											<table width="100%" border="0" cellspacing="0" cellpadding="0">
                      ...
                      style="background-color:rgb(205,300,200);"
														...
														<td align="center">
															...
															<button class="layui-btn layui-btn-mini" type="button" style="background: #50b7c1">
																<a href="Selects?id=${list.id}">编辑</a>
															</button>
