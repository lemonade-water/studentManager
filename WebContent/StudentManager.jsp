...
<script src="${aroot}/bootstrap/js/bootstrap.min.js"></script>
<script type="text/javascript" src="${aroot}/js/jquery.js"></script>
<link href="${aroot}/bootstrap/css/bootstrap.min.css" rel="stylesheet">
					...
					<form action="" class="form-horizontal">
						<table>
							...
							<tr>
								...
								<td>&nbsp;&nbsp;&nbsp;<Strong><span id="accountsssss"></span></Strong>
								</td>
							</tr>
							<tr>
								<td><strong>学生性别:</strong></td>
								<td>&nbsp;&nbsp;&nbsp;<Strong><span id="name"></span></Strong>
								</td>
							</tr>
							<tr>
								<td><strong>学生年龄:</strong></td>
								<td>&nbsp;&nbsp;&nbsp;<Strong><span id="sex"></span></Strong>
								</td>
							</tr>
							<tr>
								<td><strong>学生电话:</strong></td>
								<td>&nbsp;&nbsp;&nbsp;<Strong><span id="classnumber"></span></Strong>
								</td>
							</tr>
							<tr>
								<td><strong>学生成绩:</strong></td>
								<td>&nbsp;&nbsp;&nbsp;<Strong><span id="type"></span></Strong>
								</td>
							</tr>
						</table>
					</form>
...
<body>
	<center>
		<table width="900" border="0" cellspacing="0" cellpadding="0">
				...
				<td height="500" align="center" valign="top"><table width="900" border="0" cellspacing="0" cellpadding="0">
						<tr>
							...
							<td width="709" align="center" valign="top" bgcolor="#F6F9FE"><table width="709" border="0" cellspacing="0" cellpadding="0">
									<tr>
										<td height="30" background="${aroot}/Images/mainMenuBg.jpg" style="padding-left: 25px;">学生信息管理</td>
									</tr>
									<tr>
										<td height="470" align="center" valign="top" bgcolor="#F6F9FE">
											<form name="form1" method="post" action="StudentOAselect" id="searchForm">
												<input type="hidden" id="pageNo" name="pageNo" value="${pagerBooks.pageNo}" /> <input type="hidden" id="pageSize" name="pageSize" value="${pagerBooks.pageSize}" />
												<table width="100%%" border="0" cellspacing="0" cellpadding="0">
													<tr>
														<td width="28%" height="30" style="padding-left: 20px;">功能导航：
															<button style="background: #7bbfea">
																<a href="StudentAdd.jsp">添加学员</a>
															</button>
														</td>
														<td width="72%">查询： <select name="text1" id="searchType">
																<option value="">全部</option>
																<option value="姓名">姓名</option>
																<option value="电话">电话</option>
																<option value="用户名">编号</option>
														</select> <input name="text2" type="text" id="text2"> <input type="submit" name="button" id="button" value="点击查询"></td>
													</tr>
												</table>
											</form>
											<table width="100%" border="0" cellspacing="0" cellpadding="0">
                      ...
                      style="background-color:rgb(205,300,200);"
														...
														<td align="center">
															...
															<button class="layui-btn layui-btn-mini" type="button" style="background: #50b7c1">
																<a href="Select?id=${list.id}">编辑</a>
															</button>
															<button href="javascript:;" data-id="1" data-opt="del" class="layui-btn layui-btn-danger layui-btn-mini" style="background: #ed1941" data-toggle="modal" data-target="#delForm"
																onclick="batchDeletes('${list.id}')">删除</button>
														</td>
													</tr>
												</c:forEach>
												<tr>
											...
											</table> <c:set var="pager" value="${pagerBooks}" scope="page" /> <%@ include file="/Person/Person.jsp"%>
									</tr>
								</table></td>
						</tr>
					</table></td>
			...
			<tr>
				<td height="35" background="${aroot}/Images/bootBg.jpg">&nbsp;</td>
			</tr>
		</table>
	</center>
	<script type="text/javascript" src="${aroot}/plugins/layui/layui.js"></script>
</body>
</html>
