										...
										<td height="470" align="center" valign="top" bgcolor="#F6F9FE">
											<form name="form1" method="post" action="Classupdate?id=${list.id}" onSubmit="return mycheck()">
												<table width="100%" border="0" cellspacing="0" cellpadding="0">
													...
													<tr>
														<td height="30" align="right"><span style="color: red;"></span>班级说明：</td>
														<td><input name="classexplain" type="text" class="text2" value="${list.classexplain}"></td>
													</tr>
													<tr>
														<td height="30">&nbsp;</td>
														<td><input type="submit" name="button" id="button" value="修改班级信息"> &nbsp;&nbsp; <input type="button" name="button2" id="button2" value="返回上页"
